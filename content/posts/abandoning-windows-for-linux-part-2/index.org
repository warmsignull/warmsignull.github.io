...
#+HUGO_SUMMARY: A personal reflection on the process of learning through discomfort and persistence, told through the author’s experience of switching to a minimal Linux environment and exploring the world of Emacs, Org Mode, Org-roam, and Org-journal. This post captures the highs and lows of discovery, from breaking systems and losing focus to finding flow, clarity, and a deeper connection to knowledge itself. What starts as a technical experiment turns into a philosophy of growth, proving that self-improvement often begins where comfort ends.
...
* Day 3 – The VPN, The Firewall, and The Existential Crisis
...
* Emacs – The Ancient Weapon of Knowledge
...
* Org-roam – Building a Second Brain
...
* Org-journal – The Quiet Discipline
...
* Benefits – Why It’s Worth the Climb
