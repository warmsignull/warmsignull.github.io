...
#+DATE: 2025-11-19
#+HUGO_SECTION: posts
#+HUGO_SLUG: the-cycle-of-reinvention-and-what-a-truly-general-language-should-be
#+HUGO_BUNDLE: the-cycle-of-reinvention-and-what-a-truly-general-language-should-be
#+HUGO_TAGS: programming languages language design software history
#+FILETAGS: :programming:languages:language:design:software:history:
...
* 1. Lisp → Clojure, Rust Macros, Python Metaclasses
...
* 2. Smalltalk → Ruby, Python, JavaScript
...
* 5. Scheme → JavaScript → TypeScript
...
* 7. Prolog → Logic DSLs, SQL, Rules Engines
...
* 10. Forth → Lua → Modern Embeddables
...
* 16. Modern Meta Languages: Nim, Crystal, Julia
...
* 17. What a Truly General, Good Language Should Be
